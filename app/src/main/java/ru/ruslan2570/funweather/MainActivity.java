...
public class MainActivity extends AppCompatActivity {
	...
	public LocationListener locationListener = location -> showLocation(location);
	...
	public class WeatherHandler {
		...
		public String getWindDirection() {
			String result = "";
			if (windDirection > 348 || windDirection < 12)
				result = getResources().getString(R.string.N);
			if (windDirection > 12 && windDirection < 78)
				result = getResources().getString(R.string.NE);
			if (windDirection > 78 && windDirection < 101)
				result = getResources().getString(R.string.E);
			if (windDirection > 101 && windDirection < 168)
				result = getResources().getString(R.string.SE);
			if (windDirection > 168 && windDirection < 214)
				result = getResources().getString(R.string.S);
			if (windDirection > 214 && windDirection < 259)
				result = getResources().getString(R.string.SW);
			if (windDirection > 259 && windDirection < 304)
				result = getResources().getString(R.string.W);
			if (windDirection > 304 && windDirection < 348)
